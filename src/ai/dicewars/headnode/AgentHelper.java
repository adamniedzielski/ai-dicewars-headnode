...
public class AgentHelper {
	...
	public int maximumConnectedVertices(List<? extends Vertex> vertices, int playerNumber){
		...
		for(Vertex v : vertices){
			...
			int traversedConnected = traverse(map, new HashSet<Integer>(), v, playerNumber);
			maximumConnectedVertices = traversedConnected > maximumConnectedVertices ? traversedConnected : maximumConnectedVertices;
		}
	...
	public int maximumConnectedVerticesAfterWinningField(
			List<? extends Vertex> vertices, Vertex startVertex, int playerNumber) {
		Map<Integer, Vertex> map = getIdVertexMap(vertices);
		int maximumConnectedVertices = maximumConnectedVertices(vertices, playerNumber);
		int traversedConnected = traverse(map, new HashSet<Integer>(), startVertex, playerNumber);
		maximumConnectedVertices = traversedConnected > maximumConnectedVertices ? traversedConnected : maximumConnectedVertices;
	...
	/*
	 * Counts the maximum of connected fields of player who is in possession of startVertex
	 */
	public int maximumConnectedVerticesAfterLoosingField(
		...
		int maximumConnectedVertices = maximumConnectedVertices(vertices, previousPlayerNumber);
	...
	public void testMe(List<ConcreteVertex> vertices, Answer answer){
		int playerNumber = 0;
		System.out.println("Maximum connected vertices of ME : " + maximumConnectedVertices(vertices, playerNumber));
		System.out.println("Maximum connected vertices of EN : " + maximumConnectedVertices(vertices, oppositePlayerNumber(playerNumber)));
